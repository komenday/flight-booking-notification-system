namespace FBNS.Application.Templates;
...
public static class EmailTemplates
{
    ...
    {
        var confirmedAtLocal = confirmedAt.ToLocalTime();
        ...
        var content = $@"
            ...
            <div class=""info-box"">
                <ul>
                    <li><strong>Flight Number:</strong> {flightNumber}</li>
                    <li><strong>Seat Number:</strong> {seatNumber}</li>
                    <li><strong>Confirmed At:</strong> {confirmedAtLocal:yyyy-MM-dd HH:mm} (Local Time)</li>
                </ul>
            </div>
        ...
        string seatNumber)
    {
        var content = $@"
            ...
            <div class=""alert-box"">
                ...
                <p>Your reservation was not confirmed within the 15-minute time window and has been automatically cancelled.</p>
                <p>The seat has been released and is now available for other passengers.</p>
            </div>
